...
class GeoAccessor(object):
    ...
    .. note::
        **Setting the I/O Engine:**
        ...
        .. note::
            This variable was named `ARCGIS_GEOMETRY_ENGINE` in the 2.4.1 release. Scripts using that previous name will
            still run, but the engine will not update unless it is replaced with `ARCGIS_IO_ENGINE`.
    ...
    .. note::
        ...
        ``Transformer`` for CRS reprojection:
            ...
            - `Shapely transform <https://shapely.readthedocs.io/en/stable/reference/shapely.transform.html>`_
            - `pyproj Transformer <https://pyproj4.github.io/pyproj/stable/api/transformer.html>`_
        ...
        **Note:** Shapely geometries do not carry any CRS (Coordinate Reference System) information.
        They are simply collections of coordinates in a flat (Cartesian) space. It's up to you
        (either in your code or through a wrapper like GeoPandas) to track and apply the CRS.
    ...
    def from_df(
        ...
        """
        Creates a Spatially Enabled DataFrame from a dataframe with an address column.

        ====================    =========================================================
        **Parameter**            **Description**
        --------------------    ---------------------------------------------------------
        df                      Required Pandas DataFrame. The source dataset.
        --------------------    ---------------------------------------------------------
        ...
        .. code-block:: python
            ...
            # Usage: Create spatially enabled dataframe from a dataframe
            ...
            >>>     {"rings": [
            >>>                [
            >>>                     [10704747.836368, 1897137.258469],
            >>>                     ...
            >>>                     [10704747.836368, 1897137.258469]
            >>>                 ]
            >>>             ],
            ...
            >>>     {"rings": [
            >>>                 [
            >>>                     [10702273.187578, 1897319.001687],
            >>>                     ...
            >>>                     [10702273.187578, 1897319.001687]
            >>>                    ]
            >>>             ],
            ...
            >>>     {"rings": [
            >>>                 [
            >>>                     [10705288.792564, 1900597.135021],
            >>>                     ...
            >>>                     [10705288.792564, 1900597.135021],
            >>>                 ]
            >>>             ],
            ...
            >>>                      "geom": [poly1, poly2, poly3],
            >>>                      "oid": [1, 2, 3],
            >>>                      "city_id": ["00492", "00839", "000218"]
            >>>                     }
            >>>      )
        ...
        .. note::
            Credits will be consumed for batch_geocoding, from the *GIS*
            to which the geocoder belongs.
