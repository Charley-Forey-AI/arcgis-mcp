    ...
    def create_parameters(
        ...
        if parameters.out_fields != "*" and parameters.return_distinct_values is False:
            try:
                ...
                out_fields_list = params["outFields"].split(",")
                out_fields_list = [f.lower() for f in out_fields_list]
                if object_id_field.lower() not in out_fields_list:
