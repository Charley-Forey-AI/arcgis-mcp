...
def lengths(
    ...
    """
    Calculates the `2D Euclidean` or `geodesic` lengths of
    ...
    **Keys**            **Description**
    ...
    polylines           The list of :class:`~arcgis.geometry.Polyline` objects to compute.
                        ...
                        .. code-block:: python
                            ...
                            # Usage Example for parameter:

                            >>> from arcgis.geometry import Polyline
                            >>> from arcgis.geometry.functions import lengths
                            ...
                            >>> )
    ----------------    --------------------------------------------------------------------------------
    length_unit         A :class:`~arcgis.geometry.functions.LengthUnits` object for which unit of measure
                        to return result.
                        ...
                        * If *calculationType* is *not* planar, then must be a
                        ...
                        See valid list of *esriUnits*
                        constants: `esriSRUnitTypeConstants <https://resources.arcgis.com/en/help/arcobjects-cpp/componenthelp/index.html#/esriSRUnitType_Constants/000w00000042000000/>`_
    ----------------    --------------------------------------------------------------------------------
    calculation_type    The length calculation type used for the operation. Can be one of the following:
                        ...
                        * *geodesic* - uses only the vertices of the *polyline* and defines the
