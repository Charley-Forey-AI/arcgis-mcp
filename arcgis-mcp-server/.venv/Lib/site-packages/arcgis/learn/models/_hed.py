    ...
    **Parameter**            **Description**
    ...
    def lr_find(self, allow_plot=True, mixed_precision=False, **kwargs):
        ...
        **Parameter**            **Description**
        ...
        ---------------------   -------------------------------------------
        mixed_precision         Optional boolean or string.
                                Parameter to enable or disable mixed precision.
                                If set to `True`, optimum learning rate will be derived in mixed precision mode (fp16).
                                Only `Pytorch` based models are supported.
                                The default value is 'False'.
        =====================   ===========================================
        """
        return super().lr_find(allow_plot, mixed_precision=False, **kwargs)
