...
class Version(object):
    ...
    **Parameter**        **Description**
    ...
    def inspect(
        ...
        **Parameter**        **Description**
        ---------------     --------------------------------------------------------------------
        conflicts           Optional List.  The conflicts that are being inspected (removed)
                            from the conflict set.

                            .. note::
                                If ``inspect_all`` is True, this parameter is ignored.
        ...
        """
        if set_inspected is None:
            warnings.warn(
                "The set_inspected default parameter will be updated to True at version 2.4.3 to align with REST defaults.",
                Warning,
            )
